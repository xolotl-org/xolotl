...
use andrias_types::{MethodId, Outcome, OutputMode, Value};
...
pub(crate) const TIME_METHODS: &[MethodSpec] = &[
    MethodSpec::new("now", andrias_types::Purity::Pure, MethodSpec::UNARY_ASYNC)
        .observes_external(),
    MethodSpec::new(
        "sleep",
    ...
    MethodSpec::new("cron", andrias_types::Purity::Pure, MethodSpec::UNARY_ASYNC)
        .observes_external(),
];
