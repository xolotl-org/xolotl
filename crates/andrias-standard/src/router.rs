...
pub(crate) struct Routed {
    ...
    pub(crate) output: andrias_types::Value,
}
...
impl Router {
    ...
    #[cfg(test)]
    fn routed(&self, idx: usize, output: andrias_types::Value) -> Routed {
        Routed {
    ...
    #[cfg(not(test))]
    fn routed(&self, _idx: usize, output: andrias_types::Value) -> Routed {
        Routed { output }
    }
    ...
    async fn call_text_with_retry(
        ...
        input: &andrias_types::Value,
        method: RouteMethod,
    ) -> Result<andrias_types::Value, String> {
