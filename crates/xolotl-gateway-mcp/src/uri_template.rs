...
mod tests {
    ...
    fn templates_match_and_expose_variables() -> anyhow::Result<()> {
            ...
            mcp_uri_template_matches("xolotl://files/{path}", "xolotl://files/a/b")?,
            ...
            mcp_uri_template_variable_names("xolotl://files/{+path}{?rev}")?
                .into_iter()
                .collect::<Vec<_>>()
            ...
            !mcp_uri_template_matches("xolotl://files/{path}.md", "xolotl://files/a.txt")?,
            "template matched a mismatched extension"
        );
        ensure!(
            validate_mcp_uri_template("xolotl://bad/{").is_err(),
