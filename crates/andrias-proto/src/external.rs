...
// `proto/andrias/v1/external.proto` (package `andrias.v1.external`). `include!`d
// into the `andrias::v1::external` module. Keep in sync with the `.proto` spec.
...
pub mod external_service_server {
    ...
    pub const SERVICE_NAME: &str = "andrias.v1.external.ExternalService";
