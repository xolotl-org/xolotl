...
//! `andrias-gateway-mcp` - MCP server-side Gateway adapter.
//!
//! This crate covers Andrias as an MCP server. Gateway publications for the
...
//! still goes through [`andrias_gateway::Gateway`], so authentication, Process
