...
use andrias_types::{Fact, OperationId};
...
pub trait FactStore: Send + Sync + 'static {
    ...
    fn facts_of(&self, process: andrias_types::ProcessId) -> Result<Vec<Fact>, FactError>;
...
impl FactSink {
    ...
    pub fn facts_of(&self, process: andrias_types::ProcessId) -> Result<Vec<Fact>, FactError> {
