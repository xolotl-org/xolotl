...
//! redb-backed persistent storage adapters for Andrias.
//!
//! Provides a persistent [`StateBackend`](andrias_state::StateBackend) (state
//! plane, `state://`) and a durable [`FactStore`](andrias_kernel::FactStore).
//!
mod fact;
mod state;
...
impl RedbStore {
    /// Open or create the redb database and initialize Andrias tables.
